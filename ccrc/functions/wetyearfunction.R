...
monPrec <- "/Volumes/P_Harddrive/LAI_precip_variability/Data/Precipitation/NDVI/MONTHLYPRECIPNDVI.nc"





wetyearsrain <- function(x_data){
...
source("~/Desktop/scripts/wetyearfunction.R")

wetyearsrain(monPrec)
